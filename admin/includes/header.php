...
<header id="header" class="header fixed-top d-flex align-items-center">
  <div class="d-flex align-items-center justify-content-between">
    <?php brand_logo(app_url('admin/dashboard.php')); ?>
    <i class="bi bi-list toggle-sidebar-btn"></i>
  </div>
  <div class="search-bar">
    <form class="search-form d-flex align-items-center" method="get" action="<?= e(app_url('search.php')) ?>">
      <input type="text" name="q" placeholder="Search admin pages (students, planner…)" title="Search">
    ...
    <ul class="d-flex align-items-center">
      ...
      <li class="nav-item dropdown pe-3">
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
          <?= profile_avatar_html((string)$_SESSION['name']) ?>
