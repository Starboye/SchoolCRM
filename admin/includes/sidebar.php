<aside id="sidebar" class="sidebar">
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item"><a class="nav-link collapsed" href="students.php"><i class="bi bi-people"></i><span>Students</span></a></li>
    <li class="nav-item"><a class="nav-link collapsed" href="teachers.php"><i class="bi bi-person-badge"></i><span>Teachers</span></a></li>
    ...
    <li class="nav-item"><a class="nav-link collapsed" href="planner.php"><i class="bi bi-calendar3"></i><span>Planner</span></a></li>
    <li class="nav-item"><a class="nav-link collapsed" href="attendance_governance.php"><i class="bi bi-activity"></i><span>Attendance Gov</span></a></li>
    <li class="nav-item"><a class="nav-link collapsed" href="exams.php"><i class="bi bi-journal-check"></i><span>Exam Lifecycle</span></a></li>
    <li class="nav-item"><a class="nav-link collapsed" href="notification_center.php"><i class="bi bi-megaphone"></i><span>Notification Ctr</span></a></li>
    <li class="nav-item"><a class="nav-link collapsed" href="analytics.php"><i class="bi bi-graph-up"></i><span>Analytics</span></a></li>
